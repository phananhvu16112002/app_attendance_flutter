        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: CustomText(
                  message:
                      '${AppLocalizations.of(context)?.setting_privacy ?? 'Setting and Privacy'}',
                  fontSize: 18.sp,
                  fontWeight: FontWeight.bold,
            ...
            Padding(
              ...
              child: CustomText(
                  message:
                      '${AppLocalizations.of(context)?.display ?? 'Display'}',
                  fontSize: 18.sp,
                  fontWeight: FontWeight.bold,
                  color: AppColors.primaryText),
            ),
            customOptions(context, 'assets/icons/modeTheme.png',
                '${AppLocalizations.of(context)?.mode_theme ?? 'Mode Theme'}'),
            InkWell(
                onTap: () {
            ...
            InkWell(
                ...
                child: customOptions(context, 'assets/icons/face_camera.png',
                    '${AppLocalizations.of(context)?.view_face ?? 'View Face'}')),

            customOptions(context, 'assets/icons/information.png',
              ...
              child: Column(
                ...
                children: [
                  Center(
                    child: CustomText(
                      message:
                          '${AppLocalizations.of(context)?.choose_language ?? 'Choose Language'}',
                      fontSize: 20.sp,
                      fontWeight: FontWeight.w700,
                      color: AppColors.primaryButton,
                    ),
